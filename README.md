...
To compile the code using teams the compiler used in the makefile needs to be changed, to the commented line, both OPT and CC, using clang instead of gcc
Before that is needed to set environment with : source 